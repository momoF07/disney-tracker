...
if not df_raw.empty:
    ...
    # --- FILTRAGE : Exclure les données entre 2h00 et 7h59 ---
    # On ne garde que les données dont l'heure est < 2 ou >= 8
    ...
    if not df.empty:
        ...
        # Affichage avec heure du refresh et délai
        ...
        st.warning("📭 Aucune donnée en dehors de la période nocturne.")
